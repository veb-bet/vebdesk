...
from PyQt6.QtWidgets import (
    ...
    QMessageBox, QInputDialog, QCalendarWidget, QListWidgetItem
)
...
LIGHT_THEME = """
QMainWindow { 
    background-color: rgba(200, 180, 255, 180);
}
QLabel { color: #4B0082; font-weight: bold; }
QPushButton { background-color: #9370DB; border-radius: 12px; padding: 8px; color: white; }
QPushButton:hover { background-color: #8A2BE2; }
QTextEdit, QLineEdit, QListWidget, QCalendarWidget { 
    background-color: rgba(230, 220, 255, 180); border: 1px solid #9370DB; border-radius: 8px; 
}
QTabBar::tab:selected { background-color: #9370DB; border-radius: 10px; color: white; }
"""

DARK_THEME = """
QMainWindow { 
    background-color: rgba(75, 0, 130, 180);
}
QLabel { color: #D8BFD8; font-weight: bold; }
QPushButton { background-color: #4B0082; color: white; border-radius: 12px; padding: 8px; }
QPushButton:hover { background-color: #9370DB; }
QTextEdit, QLineEdit, QListWidget, QCalendarWidget { 
    background-color: rgba(75, 0, 130, 180); color: white; border: 1px solid #9370DB; border-radius: 8px; 
}
QTabBar::tab:selected { background-color: #9370DB; border-radius: 10px; color: white; }
"""
